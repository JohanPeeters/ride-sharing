...
* the *script-src* CSP directive was designed to mitigate the risk of script injection (XSS). Unless explicitly allowed, the browser refuses to run any inline scripts. However, React 
